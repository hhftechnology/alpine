...
LABEL maintainer="HHF Technology (github.com/hhftechnology)"
...
### Set defaults
ENV FLUENTBIT_VERSION=${FLUENTBIT_VERSION:-"3.2.3"} \
    S6_OVERLAY_VERSION=${S6_OVERLAY_VERSION:-"3.2.0.2"} \
    YQ_VERSION=${YQ_VERSION:-"v4.44.2"} \
    ZABBIX_VERSION=${ZABBIX_VERSION:-"7.2.1"} \
    ...
    IMAGE_NAME="hhftechnology/alpine" \
    IMAGE_REPO_URL="https://github.com/hhftechnology/alpine/"
